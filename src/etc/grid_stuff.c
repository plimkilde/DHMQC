...
*/
static double simple_bilin(double *grid, double x, double y, double *geo_ref, double nd_val, ssize_t nrows, ssize_t ncols);
...
DLL_EXPORT void wrap_bilin(double *grid, double *xy, double *out, double *geo_ref, double nd_val, ssize_t nrows, ssize_t ncols, ssize_t npoints){
	ssize_t k;
	for(k=0; k<npoints; k++){
...
DLL_EXPORT void resample_grid(double *grid, double *out, double *geo_ref, double *geo_ref_out, double nd_val, ssize_t nrows, ssize_t ncols, ssize_t nrows_out, ssize_t ncols_out){
	ssize_t i,j;
	double x,y;
