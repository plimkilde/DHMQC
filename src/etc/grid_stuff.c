 ...
 */
#include <stdlib.h>
#include "../triangle/trig_index.h" /* for index_t typedef */
#ifdef _MSC_VER
...
*/
static double simple_bilin(double *grid, double x, double y, double *geo_ref, double nd_val, index_t nrows, index_t ncols);
...
DLL_EXPORT void wrap_bilin(double *grid, double *xy, double *out, double *geo_ref, double nd_val, index_t nrows, index_t ncols, index_t npoints){
	index_t k;
	for(k=0; k<npoints; k++){
...
DLL_EXPORT void resample_grid(double *grid, double *out, double *geo_ref, double *geo_ref_out, double nd_val, index_t nrows, index_t ncols, index_t nrows_out, index_t ncols_out){
	index_t i,j;
	double x,y;
